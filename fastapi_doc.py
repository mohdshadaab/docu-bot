...
def clean_scraped_content(content):
    ...
    # Optional: You may want to add specific rules for unnecessary blocks (like feedback sections)
    content = re.sub(r'Was this page helpful\?.*Thanks for your feedback!', '', content)
